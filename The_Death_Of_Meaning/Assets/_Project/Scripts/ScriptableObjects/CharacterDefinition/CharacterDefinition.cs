...
namespace TDOM.Data
{
    ...
    {
        public float Gravity, TerminalVelocity, LowJumpMultiplier, JumpVelocity;
        public int   MaxJumps;
        public float CoyoteTime, BufferTime;
        public float BaseSpeed, SprintSpeed, Acceleration, Friction, AirControl;
    }

    [CreateAssetMenu(menuName = "tdom/Dash Profile")]
    public sealed class DashProfile : ScriptableObject
    {
        public float          Distance, Duration, Cooldown, MaxTurnRate;
    ...
    public sealed class ComboProfile : ScriptableObject
    {
        ...
        public float        HoldThreshold, MaxChargeTime, BufferWindow;
    }
