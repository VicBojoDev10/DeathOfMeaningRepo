...
namespace TDOM.Contracts
{
    public readonly struct InputSnapshot
    {
        ...
        public InputSnapshot(Vector2 move, Vector2 look, bool jumpPressed, bool jumpHeld,
            bool dashPressed, bool sprintPressed, bool attackPressed, bool attackHeld,
            bool attackReleased, bool aimHeld, bool firePressed, bool fireHeld,
            bool fireReleased, bool grapplePressed)
        {
            Move = move; Look = look;
            ...
            AttackPressed = attackPressed; AttackHeld = attackHeld; AttackReleased = attackReleased;
            AimHeld = aimHeld; FirePressed = firePressed; FireHeld = fireHeld;
            FireReleased = fireReleased; GrapplePressed = grapplePressed;
        }
    }
    public readonly struct MotionIntent
    {
        ...
        public MotionIntent(Vector3 velocity, bool ignoreGravity = false, bool ignoreCollision = false)
        {
            Velocity = velocity; IgnoreGravity = ignoreGravity; IgnoreCollision = ignoreCollision;
        }
    }
    ...
    public enum LocomotionPhase { Grounded, Airborne, Dashing, Grappling, Attacking }
    [System.Serializable]
