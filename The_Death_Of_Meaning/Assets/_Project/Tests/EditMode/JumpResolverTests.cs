...
namespace TDOM.Tests.EditMode
{
    public sealed class JumpResolverTests
    {
        ...
        private InputSnapshot ConSalto() => new InputSnapshot { JumpPressed = true, JumpHeld = true };
        private InputSnapshot SinInput() => new InputSnapshot { JumpPressed = false, JumpHeld = false };

        [Test]
        public void Ayla_puede_saltar_dos_veces_en_el_aire()
        {
            var resolver = new JumpResolver(maxSaltos: 2, velocidadSalto: 15f, coyoteTime: 0.12f, bufferTime: 0.15f);
            var estado = new LocomotionState { IsGrounded = false, JumpsUsed = 0, Velocity = Vector3.zero };
        ...
        {
            var resolver = new JumpResolver(maxSaltos: 1, velocidadSalto: 15f, coyoteTime: 0.12f, bufferTime: 0.15f);
        ...
        {
            var resolver = new JumpResolver(maxSaltos: 1, velocidadSalto: 15f, coyoteTime: 0.12f, bufferTime: 0.15f);
            var estado = new LocomotionState { IsGrounded = false, JumpsUsed = 0, CoyoteTimer = 0.12f };
        ...
        {
            var resolver = new JumpResolver(maxSaltos: 1, velocidadSalto: 15f, coyoteTime: 0.12f, bufferTime: 0.15f);
            var estado = new LocomotionState { IsGrounded = false, JumpsUsed = 0, CoyoteTimer = 0.10f };
        ...
        {
            var resolver = new JumpResolver(maxSaltos: 1, velocidadSalto: 15f, coyoteTime: 0.12f, bufferTime: 0.15f);
            var estado = new LocomotionState { IsGrounded = false, JumpsUsed = 1, BufferTimer = 0f };
